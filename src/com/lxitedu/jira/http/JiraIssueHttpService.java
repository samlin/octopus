...
public class JiraIssueHttpService extends AbstractJiraIssueService {
	...
	public static void createIssue(JiraIssue issue, String createUrl) throws IOException, Exception {
	...
	public static void createIssue(JiraIssue issue) throws IOException, Exception {
		createIssue(issue, "/secure/CreateIssueDetails.jspa");
	}
	...
	public static void createSubIssue(JiraIssue issue) throws IOException, Exception {
		createIssue(issue, "/secure/CreateSubTaskIssueDetails.jspa");
	}
}
