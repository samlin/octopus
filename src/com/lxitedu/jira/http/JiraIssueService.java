...
public class JiraIssueService extends AbstractJiraIssueService {
  ...
  public static void createIssue(  JiraIssue issue) throws IOException, Exception {
    ...
    String createUrl = "/secure/CreateIssueDetails.jspa";
  ...
  // TODO 这里的10000是issue所在的project的id,必须要传入过来
    post.addParameter("pid", "10000"); 
    post.addParameter("issuetype", "1"); //$NON-NLS-1$
